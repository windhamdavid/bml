...
<body>
	...
	<div id="horizon" data-0="right:0%" data-4000="right:0%" data-5000="right:-27%" data-6000="right:-27%" data-11000="right:-166%">
	<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="3300" height="300">
		...
		data-2000="stroke-dashoffset:6000;" data-7000="stroke-dashoffset:0;" 	
		d="M3300.3,0
			...
			h-3.7v0.5h-12.1v-1.5h-5.2v-5.2h-2v-38.3l-13.4,2.5v3.2h-3.7v1.7h-1.5v30.5h-3.7V254h-3.4v-0.8h-1.3v-2.1l-8.1-0.4l-2.5,0.7v1.5
			h-3.5v15.7l-2.9-0.9V253l-4.7-4.9v-1l-1-0.8l-1.2,0.8v0.8h-1.7v-3.2l-0.5-0.5v-0.8l-2.7-0.8v-1.9l-3.4-0.7l-4,0.9v1.4l-0.7,1.1h-2.5
			v3.4h-5.4v-7.9l-4.4-0.4V234h-12.1v-1.8h-11.1v2.7l-1.7-0.3h-8.1v0.8h-1.3v1.8h0.8v7.2l-2.9,4h-1.3v3.5l-5.7-0.4v-1.7h-2v-1.3
			...
			l-5,4.4v2.9h-1.5v-6.6l-4-0.4v-0.7h-3v0.7l-5.7,1.2v2h-1v-4h-0.8v0.7h-2.3v-0.8h-0.8v3.9h-1.7v0.7h-1.7v1.5h-0.5v2h-0.7v4.5h-0.2
			v15.4l-8.1,0.3v4.2h-1.2v0.5h-0.3v-0.8l-0.4-0.4l-0.4,0.4v0.7h-0.3V245l-4.7-10.7h-1.2v-17.6h-2.7v-7h-0.7v-3.8l-5.7-0.2v-2.3h-0.6
			c-4.1-9.6-18.2-9.1-21.7,0.2h-0.7v2.5h-1.2v-39.2h-1.2v-0.3h-24.3l-3.7,1.2v21.1h-2.2V186l-14.1-8.6l-13.9,10v1.1l-0.2,0v1.1
			...
			l-8.7,1.8v46.8h-5.5v-22.3h-2v-4.4h-2l-0.4-0.5h-1v0.5h-2.4l-1.3,0.5v4l-0.7,0.5v11.4l-0.7,0.5v3l-1.7,1.6v3l-0.7,0.3v11.6H2489
			v-20.8c0-1.7-0.8-1.7-0.8,0h-0.5v-16.2l-0.8-2.2V197l-1-0.6V195l-2.8,0.1l-0.3-1.1l-0.3,1.5l-11.8,1v33.8l-0.5-0.5l-0.5,0.5V244
			...
			l-1.4-1l-1.4,1.1v3.4l-0.8,0.7v2.3h-1.8v-0.3h-3v-0.3h-1.5v-1h-0.8v-0.5h-1v0.3h-0.5v-0.3h-0.7v0.5h-0.5v-0.5h-1v1h-1.2v-4.2h-10.4
			...
			v-0.5h-0.5v-1.1l-0.7-0.1V241l-0.5-0.5v-5l-1-1v-2.2l-0.5-0.3v-1.9c0.3-0.1,0.4-0.4,0.4-0.6c0-0.4-0.3-0.7-0.7-0.7
			c-0.4,0-0.7,0.3-0.7,0.7c0,0.3,0.2,0.5,0.3,0.6v2l-0.5,0.3v2.2l-0.8,1v-0.6l-0.3,0.1v5.5l-0.3,0.2v1.5h-0.3V241l-0.3,0.4v4.3
			l-0.4-1.2l-1.3,4.2l-0.3,5.4h-1.5v0.5h-1.3v-0.5h-1.8v0.3h-1.7V254h-6v-1.3h-0.3v1.2l-2.9,1.7h-0.8v1.2h-1.2v22h-4.2v-16.3h-2.2
			v-15.5l-1.1-0.4l0.1-5h-1.8v-1.5h-0.7v-0.7h-2v-1.6l-0.5-1.4h-0.6l-0.3-0.6c0-2.4-4-2.4-3.9,0l-1.4,1.7v1.7h-0.3v-4h-3.4v-1
			l-0.5-0.5v-1l-0.2,0.2v0.9l-0.7,0.5v0.8l-3.2,0.4v-0.5h-0.5v3.3l-0.3,0.6h-2.7v-0.8h-0.7v0.7h-4.2l-2.9,0.7v9.6h-1.3v-0.8h-2.2v0.8
			h-0.8v-16.9h-0.3v-1.8l-0.7-0.8h-3v-5l-1.5-1.7h-13.6v0.5h-16.4c0-1.8-3.5-1.8-3.5,0h-5.7v11.1h-3.5v8.1h-2v1h-0.3v2.2h-0.2v3.9
			h-0.3v6.7h-0.3v1.3h-3.7v2.5h-0.5v4.7h-0.8v-27h-6.5v-3.5h-4.4l-3.1,0.5v3.9h-8.2v-0.8h-0.5v0.7h-3.6l-2.6,0.5V263h-1.3v-2h-0.5
			v-1.5h-0.7v-1.7h-1.5v1.7h-0.7v1.5h-0.7v2h-0.7v3h-1.5v-2.5h-0.7v-0.8h-4.2V260h-0.7v-2.3h-0.5v-21.5h-7.5v-1h-0.5v1h-8.4V232h-4.8
			l-2.5,0.5v3.7h-1.1l-4.6,1V260h1v6.9h-2.7V265h-4.5v-57.4h-2v-2.3h-3.4c-0.6-2.3-0.9-4.9-0.6-5.5v-0.3h-3l0.3-0.7h-0.7v-1.5l0.8-0.8
			...
			l-1.4,2v4.5h-0.8v-1.5h-2.9v1.5h-3.2v-14.3h-1.8v-0.8h-1.7v-1.8h-0.8v-1.8h-1.7v-2.7l-3.3-1.7l0-4.4l-4.4-1.6v-5.3l-0.3-0.3v-3.2
			...
			h-2.2l-2.9,5.9v7.2l-0.7,0.7v3.2h-2.5v-4l-1-1h-17.1v1.8h-0.8v6.4h-16.4v4.2h-5.8l-0.1,4.9h-3.9v9.6L0,292v15l3311-3.5
	...
	<div id="story">
		<div id="story_wrap" data-5000="background:rgba(255,255,255,0);" data-5700="background:rgba(235,235,255,.5);" data-7000="background:rgba(255,255,255,0);">
			...
			<div class="story transform" data-4400="top:200%" data-5000="top:35%;" data-6000="top:35%;"
			 data-6100="transform:scale(1);opacity:1;" data-7100="transform:scale(5);opacity:0;">
		...
		<div class="story" data-9000="top:100%" data-10000="top:15%;" data-11000="top:15%;">
				...
				<div id="bmlcount"></div>
				<div class="wish">	
					<a href='wish'><div id="heart" class="pulse"><div class="well"><h2>Wish Us Well</h2></div></div></a>
				</div>
		</div>	
	</div>
